...
const paths = {
    jsFiles: [
        ...
        './src/views_components/title.js',
        './src/views_components/next_button.js',
        './src/views_components/back_button.js',
        './src/views_components/textfield.js',
        './src/views_components/dropdown_button.js',
        './src/views_components/file_upload_view.js',
        './src/views_components/gradient_loading_bar.js',
        './src/views_components/position_map.js',
