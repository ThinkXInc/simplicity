...
class SVGIcons {
    static get enterButtonSVG() {
        ...
        <svg id="EnterButtonSVG" class="enterButtonSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 111.14 111.14">
            <defs>
                <style>
                    .spl-arrow {fill: none; stroke: #333; stroke-linecap: round; stroke-width: 6px;} 
                    .spl-arrow, .spl-bg {stroke-miterlimit: 10;} 
                    .spl-bg {fill: #eee; stroke: #ccc; stroke-width: 2px;}
                </style>
            </defs>
            <circle class="spl-bg" cx="55.57" cy="55.57" r="55.07"/>
            <line class="spl-arrow" x1="30.41" y1="55.65" x2="80.73" y2="55.65"/>
            <line class="spl-arrow" x1="80.73" y1="55.49" x2="63.02" y2="37.78"/>
            <line class="spl-arrow" x1="80.73" y1="55.64" x2="63.02" y2="73.36"/>
        </svg>
        `;
    }
    ...
    static get editIconSVG() {
        return `
            <svg id="EditIconSVG" class="editIconSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 82.98 70.3">
                <defs>
                    <style>
                        .spl-cls-1 { stroke-linecap:round; }
                        .spl-cls-1, .spl-cls-2 { fill:none; stroke:#fff; stroke-miterlimit:10; stroke-width:4px; }
                    </style>
                </defs>
                <path class="spl-cls-2" d="m62.8,10.99l-3.95-3.95s-.64-.9-1.55,0S16.27,48.07,16.27,48.07c0,0-.47.36-.56.99-.18.65-3.18,11.68-3.18,11.68,0,0-.17.5,0,.72s.79,0,.79,0l12.24-3.93s.44-.09.9-.49,40.76-40.76,40.76-40.76c0,0,.37-.49.15-.74s-4.54-4.6-4.58-4.55Z"/>
                <line class="spl-cls-1" x1="13.37" y1="61.63" x2="38.32" y2="61.63"/>
                <line class="spl-cls-1" x1="44.75" y1="61.63" x2="58.06" y2="61.63"/>
            </svg>
        `;
    }
    ...
    static get doneIconSVG() {
        return `
            <svg id="DoneIconSVG" class="doneIconSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50.26">
                <defs>
                    <style>.spl-cls-1 { fill:none; stroke:#fff; stroke-miterlimit:10; stroke-width:4px; }</style>
                </defs>
                <polyline class="spl-cls-1" points="9.7 26.76 20.15 37.2 41.8 14.52"/>
            </svg>
        `;
    }
    ...
    static get cancelIconSVG() {
        return `
            <svg id="CancelIconSVG" class="spl-cancelIconSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58.94 58.94">
                <defs>
                    <style>.spl-cls-1 { fill:none; stroke:#fff; stroke-miterlimit:10; stroke-width:6px; }</style>
                </defs>
                <line class="spl-cls-1" x1="2.12" y1="2.12" x2="56.81" y2="56.81"/>
                <line class="spl-cls-1" x1="2.12" y1="56.81" x2="56.81" y2="2.12"/>
            </svg>
        `;
    }
    ...
    static get deleteIconSVG() {
        return `
            <svg id="DeleteIconSVG" class="spl-deleteIconSVG" version="1.1" id="delete" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 36 36" style="enable-background:new 0 0 36 36;" xml:space="preserve">
                <style type="text/css">
                    .spl-path{fill:#FFFFFF;}
                </style>
                <path id="path" class="spl-path" d="M24,0.8c1.1,0.5,2.3,1,3.4,1.5c2.3,1.1,3,2.6,2,5c0.2,0.1,0.5,0.3,0.7,0.4C31,8.1,32,8.5,32.9,9
